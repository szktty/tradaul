...
void main() {
  group('LuaLargeInteger', () {
    ...
    test('arithmetic operations', () {
      ...
      final sum = a.add(b);
      expect(sum.value, 
        equals(BigInt.parse('1111111110111111111011111111100')));
      
      final diff = b.subtract(a);
      expect(diff.value, 
        equals(BigInt.parse('864197532086419753208641975320')));
      
      final product = LuaLargeInteger.fromInt(123)
          .multiply(LuaLargeInteger.fromInt(456));
    ...
    test('string representation', () {
      ...
      expect(largeInt.toString(), 
          equals('#123456789012345678901234567890'));
      expect(largeInt.luaRepresentation, 
          equals('123456789012345678901234567890'));
    });
